...
>![](../assets/Pasted%20image%2020250227211645.png)
### set, unordered_set
#### set
使用条件：
```cpp
...
```
![总表](../assets/Pasted%20image%2020250303235828.png)
...
| :--------------------------------: | :---------------------------------: | :---------------------------------: | :---------------------------------: |
| ![ceil](../assets/math-ceil.svg) | ![ceil](../assets/math-floor.svg) | ![ceil](../assets/math-trunc.svg) | ![ceil](../assets/math-trunc.svg) |
